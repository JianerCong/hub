 ...
 \begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \node[below right, ndp-dialog] at (-7cm,5cm){
      \coli{Step 1: \texttt{Router Solicitation}:}
      {\color{gray}\small
    ...
    \node[above right, ndp-dialog] at (-4cm,-4cm){
      \colii{Step 2: \texttt{Router Advertisement}:}
      \colz{\small
...
\begin{figure}
 ...
 \begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \node[below right, ndp-dialog] at (-7cm,5cm){
      \coliii{Step 3: \texttt{Neighbor Solicitation}:}
      {\color{gray}\small
        Sent by a node to
        \begin{enumerate}
    ...
    \node[above right, ndp-dialog] at (-4cm,-4cm){
      \coliv{Step 4: \texttt{Neighbor Advertisement}:}
      \colz{\small
